...
Future<void> init() async {
  ...
  // Repositories
  sl.registerLazySingleton(() => ZoneRepository(sl()));
  sl.registerLazySingleton(() => StreetRepository(dbHelper: sl()));
  sl.registerLazySingleton(() => FamilyRepository(sl()));
  ...
  sl.registerLazySingleton(() => FollowupRepository(sl()));
